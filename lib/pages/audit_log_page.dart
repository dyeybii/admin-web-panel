  ...
  Future<void> _fetchAuditLogs() async {
    ...
    try {
      ...
      setState(() {
        ...
        _filteredLogs = List.from(logs); // Initialize filtered logs with all data
      });
  ...
  void _applyTimeFilter() {
    ...
    setState(() {
      if (selectedTimeRange == 'Current') {
        ...
        _filteredLogs = List.from(_auditLogs); // Show all logs if no filter is selected
      }
    });
  }
              ...
              child: DropdownButton<String>(
                ...
                onChanged: (newValue) {
                  setState(() {
                    ...
                    _applyTimeFilter(); // Apply the selected filter
                  });
                },
