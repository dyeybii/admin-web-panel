// pie_chart_mobile.dart
import 'package:fl_chart/fl_chart.dart';
import 'package:flutter/material.dart';

class ResponsivePieChartMobile extends StatefulWidget {
  final int totalUsers;
  final int onlineUsers;

  const ResponsivePieChartMobile({
    Key? key,
  ...
  @override
  _ResponsivePieChartMobileState createState() =>
      _ResponsivePieChartMobileState();
}

class _ResponsivePieChartMobileState extends State<ResponsivePieChartMobile> {
  int touchedIndex = -1;
